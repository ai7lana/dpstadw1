...
('Carlos Mendes', 'carlitos', '$2y$10$RscQezS0PsjAspwr1L9KdOGfMXqg25zV73e6I83SNXHjHqfvwlNma', 'carlos@gmail.com'),
('Juliana Rocha', 'ju_rocha', '$2y$10$cpBdI3OyZ2WlsICsSnSkKuKe61oUI6/L5fK9EtDtjys7TnxUdnVla', 'juliana@gmail.com'),
('Ricardo Lima', 'rickychef', '$2y$10$OZyVCpjUi6b9HlSQZZbt3.Tn3tqjqx0b6YYKEn78mc4dpjk/oRCWS', 'ricardo@gmail.com'),
('Patrícia Alves', 'patycozinha', '$2y$10$telx6tP5c.W4k9zchcdsuOJUagBJwW4w.vHxjlQLefH7SMEghn88y', 'patricia@gmail.com'),
('Marcos Paulo', 'marquinhos', '$2y$10$QlNhDyWEi.Byv7Q2QKAtiujaR6lp0YmMxEUDNvp9hadKK70fiDJiy', 'marcos@gmail.com'),
...
('Canjica', 'Sobremesa', 'Milho branco, leite, leite condensado, coco', 'Cozinhe o milho e adicione os outros ingredientes...', '2h', '10 porções', 'canjica.jpg', 'Centro-Oeste', 6),
('Escondidinho de Carne', 'Jantar', 'Carne moída, purê de batata, queijo', 'Monte camadas e leve ao forno...', '1h', '6 porções', 'escondidinho.jpg', 'Sul', 7),
('Bolo de Cenoura', 'Sobremesa', 'Cenoura, farinha, açúcar, óleo, ovos', 'Bata tudo e asse por 40min...', '50min', '10 fatias', 'bolo_cenoura.jpg', 'Sudeste', 6),
...
(5, 6, 'Recheio cremoso, ficou ótimo!', 5),
(5, 7, 'Cobertura perfeita!', 5),
(1, 6, 'Muito refrescante.', 4),
(2, 5, 'Bem recheado e saboroso.', 5),
(3, 7, 'Clássico mineiro bem feito!', 5);
